...
fill(0);                             // schreibt nochmal Load auf den grün übermalen butten
 ...
 fill(0, 200, 0);                       //malt den Load button grün über
  ...
  saveFrame(feld+"SavesMovie/"+feld+"Movie######.png");
