...
public class PiratenkarteV4_2_DVL_edit extends PApplet {
...
public void setup() {
 ...
 stroke(0);
  ...
  rect(100, 900, 150, 50 );
fill(0);
  text("Piraten", 110, 920);
   text("Karte ", 110, 935);
   delay(250);
           stroke(0);
     fill(0, 255, 0);                       //malt den Load button grün über
   stroke(0);
     fill(0, 255, 255);                       //malt den Load button grün über
  ...
  rect(300, 900, 150, 50 );
fill(0);
  text("Nächtes Bild ", 310, 920);
   text("Nummer "+bnr, 310, 935);
  ...
  rect(500, 900, 150, 50 );
fill(0);
  text("Bild local", 510, 920);
   text("Speichern ", 510, 935);
...
//else{
  ...
  if ((mouseoverx >= 310 && mouseoverx <= 380) && (mouseovery  >= 50 && mouseovery  <=100)) {//??
    ...
    if (mousePressed&&Admin==1) {
    mouseoverx=0;mouseovery=0;
         PImage bild;String[] lines = loadStrings("list.txt");


 webImg = loadImage(lines[0]+"/dvl/"+feld+"bild.png");
...
i++;
  ...
  if (((turn==0&& set==0)||turn==0&&run1==2)||PK==1) {              //spieler1 namensfeld
    if (spieler==1) {
      stepx=0;
      stepy=0;
      int check=0;
...
int i = 0;   
 ...
 if ((mouseoverx >= 100 && mouseoverx <= 250) && (mouseovery  >= 900 && mouseovery  <=950)) {//??
    if (mousePressed&&PK==1) {PK=0;fill(0, 255, 0);  rect(100, 900, 150, 50 );
fill(0);
  text("Piraten", 110, 920);
   text("Karte ", 110, 935);delay(200);}else{
  stroke(0);
     fill(0, 255, 255);                       //malt den Load button grün über
 PK=1;
...
fill(0);
  text("Bild Local", 710, 920);
   text("Laden ", 710, 935);
    ...
    if ((mouseoverx >= 300 && mouseoverx <= 450) && (mouseovery  >= 900 && mouseovery  <=950)) {//??
         stroke(0);
     fill(0, 255, 0);  
...
fill(0);
  text("Nächtes Bild ", 310, 920);
   text("Nummer "+bnr, 310, 935); stroke(0);
     fill(0, 255, 255);                       //malt den Load button grün über
 PK=1;
...
if(bnr<10){
   webImgPK = loadImage(lines[0]+feld+"bild"+bnr+".png");
   
}
     if (webImgPK != null){
      image(webImgPK, 0, 0);  stroke(0);
     fill(0, 255, 255);                       //malt den Load button grün über
...
fill(0);
  text("Nächtes Bild ", 310, 920);
   ...
   else while(webImgPK == null||bnrb==0)
{bnr++; webImgPK = loadImage(lines[0]+feld+"bild"+bnr+".png"); if (bnr>9){
          fill(200, 0, 0);
          rect(310, 50, 70, 50 );
          fill(0);
          text("Kein", 329, 70);
...
fill(0);
  text("Bild Local", 710, 920);
   text("Laden ", 710, 935);
     ...
     if ((mouseoverx >= 500 && mouseoverx <= 650) && (mouseovery  >= 900 && mouseovery  <=950)) {//??
    if (mousePressed/*&&PK==1*/) {
    saveFrame(+feld+"bild.png");
  
  
 }}
  
  if ((mouseoverx >= 700 && mouseoverx <= 850) && (mouseovery  >= 900 && mouseovery  <=950)) {//??
...
for (int i = 0 ; i < lines.length; i++) {
  println(lines[i]);}
    ...
    bildPK = loadImage(feld+"bild.png");
   
     
     if (bildPK != null){
      image(bildPK, 0, 0);  stroke(0);
     fill(0, 255, 255);                       //malt den Load button grün über
 
 rect(700, 900, 150, 50 );
fill(0);
  text("Nächtes Bild ", 810, 920);
   text("Nummer "+bnr, 810, 935);} else 
{
          fill(200, 0, 0);
          rect(310, 50, 70, 50 );
          fill(0);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "PiratenkarteV4_2_DVL_edit" };
    if (passedArgs != null) {
