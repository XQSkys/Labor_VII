...
void setup() {
  ...
  stroke(0);
     fill(0, 200, 100);                       //malt den Load button grün über
 
  rect(100, 900, 150, 90 );
fill(0);
  text("Editor", 160, 950);
   text("Aktiviren", 160, 970);
...
fill(0);
  text("Editor", 160, 950);
   text("Aktiviren", 160, 970);
   if ((mouseoverx >= 100 && mouseoverx <= 250) && (mouseovery  >= 900 && mouseovery  <=990)) {//??
    if (mousePressed) {
  stroke(0);
...
while(drop==2){
 ...
 if (mousePressed) {
  poswegx2=170+karte*karteex;
   ...
   if (((mouseoverx >= poswegx2+kartenweg) && (mouseoverx <= poswegx2+kartenweg+kartenweg+kartenweg)) && ((mouseovery  >= poswegy2+kartenweg) && (mouseovery  <=poswegy2+kartenweg+kartenweg))) {//??
