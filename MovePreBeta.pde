...
// seeC=get(170+660/feld*(stepx)+660/feld/2,170+ 660/feld*stepy+660/feld/2);
 ...
 if(spieler==1&&turn==2) {fill(0);
   ...
   stroke(0,0,0,0);
       ...
       if (keyPressed) {
    if (key == 'a' ) {
      wegli1=get(170+stepx*660/feld  +kartenweg/2,170+stepy*660/feld+kartenweg  +kartenweg/2);
   
      wegli2=get(170+stepx*660/feld-kartenweg  +kartenweg/2,170+stepy*660/feld+kartenweg  +kartenweg/2);

      
      if((color(0)!=wegli1)&&(color(0)!=wegli2)){
        fill(255);
        rect(170+stepx*660/feld+kartenweg,170+stepy*660/feld+kartenweg,kartenweg,kartenweg);
      
      fill(Pirat);
      rect(170+stepx*660/feld+kartenweg-660/feld,170+stepy*660/feld+kartenweg,kartenweg,kartenweg);
  ...
  turn=1;
    ...
    if (key == 'd' ) {
       wegre1=get(170+stepx*660/feld  -kartenweg/2,170+stepy*660/feld+kartenweg  +kartenweg/2);
   
      wegre2=get(170+stepx*660/feld+kartenweg  +kartenweg/2,170+stepy*660/feld+kartenweg  +kartenweg/2);
    ...
    if (key == 's' ) {
                 wegun1=get(170+stepx*660/feld +kartenweg +kartenweg/2,170+stepy*660/feld+kartenweg*2  +kartenweg/2);
   
      wegun2=get(170+stepx*660/feld+kartenweg  +kartenweg/2,170+stepy*660/feld+kartenweg*3  +kartenweg/2);
      ...
      fill(Pirat);
      rect(170+stepx*660/feld+kartenweg,170+stepy*660/feld+kartenweg+660/feld,kartenweg,kartenweg);
    turn=1;
  
    }
    }
    if (key == 'w' ) {
                 wegob1=get(170+stepx*660/feld +kartenweg +kartenweg/2,170+stepy*660/feld-kartenweg*2  +kartenweg/2);
   
      wegob2=get(170+stepx*660/feld+kartenweg  +kartenweg/2,170+stepy*660/feld-kartenweg*3  +kartenweg/2);
